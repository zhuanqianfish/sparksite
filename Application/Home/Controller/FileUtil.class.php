...
class FileUtil {
     ...
     * @return boolean
     */
    function createFile($aimUrl, $fileContent, $overWrite = false) {
		...
		//$aimUrl = 'D:/xampp/htdocs/sparksite/Site/index.html';
		file_put_contents($aimUrl, $fileContent, "w+");
		if(!$flag){
			var_dump($flag);
			echo ($flag."尝试向文件".$aimUrl."写入失败！");
			return false;
		}
        return true;
    }
